...
export const isCreateTray = typeof process !== 'undefined' && process.env.IS_ELECTRON_DEV && (isWindows || isLinux || (isMac && !window?.electron?.app?.dock));
export const isCreateMpris = typeof process !== 'undefined' && process.env.IS_ELECTRON_DEV && isLinux;
